...
from map_reduce_single import *

def run_single():
    print("\nRunning test1 word count\n")
    map_reduce_single(test1_get_inputs, test1_map_funciton, test1_reduce_function)
    print("\nRunning test2 sort array\n")
    map_reduce_single(test2_get_inputs, test2_map_funciton, test2_reduce_function)
    print("\nRunning test3 total salary of each department\n")
    map_reduce_single(test3_get_inputs, test3_map_funciton, test3_reduce_function)
...
if __name__ == '__main__':
    ...
    print("\nONE PROCESS FOR MASTER, MAPPER, REDUCER")
    run_single()
    print("\nMULTI PROCESS FOR MASTER, MAPPER, REDUCER")
    run_multi()
